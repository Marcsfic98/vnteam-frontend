...
function LoginPage() {
  return (
    <div className="pt-10 bg-black h-full w-full flex-col items-center justify-center text-gray-800 relative">
      <div className="w-full flex-col items-center justify-center h-[100vh] text-gray-800 bg-black  relative bg-[url('/img/bn_home.webp')] bg-image bg-cover bg-bottom">
        <img
          src="/logo/logo.svg"
          alt="Logo"
        ...
        <div className="bg-blue-600 rounded-t-xl absolute bottom-0 w-full h-2/5 flex-col text-cyan-50 items-center justify-center flex">
